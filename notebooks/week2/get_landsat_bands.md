...
To get started, you'll need your username and password that you created at https://urs.earthdata.nasa.gov/

The easiest way to create your `~/.netrc` file keeping your username and password for future use is to:
...
The next time you need to download or search HLS data you should just be able to do:
